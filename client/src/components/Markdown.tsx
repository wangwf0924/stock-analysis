...
type ControlsConfig = ComponentProps<typeof Streamdown>["controls"];

type MarkdownProps = Omit<ComponentProps<typeof Streamdown>, "components" | "plugins" | "controls"> & {
  ...
  /** Controls config for code/mermaid blocks */
